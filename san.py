...
cl.login(token="EnKfuK6GEH0NctRAeahf.xcxrhTOw8UhYWzUOJqKzxW.PwuU6qPiqUA/YVkLwvBG8B5xn+azXZ/scTbmeXKQkBQ=")
cl.loginResult()
#vidia
kt = LINETCR.LINE() #1 
kt.login(token="EnO6gdQ9Ha4VfjaoMu77.qczE+fqECZfL8b0QA9XtfW./5pEjSPNwTMdFhDPsDnrVII7B0z87k+XhdUNRfNGTxY=")
kt.loginResult()
#rosetta
ks = LINETCR.LINE() #2
ks.login(token="End7nYQv55LXIowKSnFa.ePXpM3e81NKzdiuCjAexQG.htN3xxcYwQSFYGTtcJbLTQTGLTQ8fIPqQ/Tab0RH8xs=")
ks.loginResult()
#sirvelmist
ki = LINETCR.LINE() #3
ki.login(token="EnkOYqGdaR5EaGZejF72.o5OJSUsg7dXvveMtSPtkqG.YXe0fedUi2HYDJlqf16DoIw/R3b9IOCpzOp3vxM+oP4=")
ki.loginResult()
#fawn
kk = LINETCR.LINE() #4
kk.login(token="EnM8KPtdpmrCFELI3Vp4.XbemDkcGRdmfYewH8sUW5a./1z0JAKRqBfKPwrZn1U4FKH4O7GlBVNQV1uRnH5JlU4=")
kk.loginResult()
#iridessa
kc = LINETCR.LINE() #5
kc.login(token="EnCg3GluVleu5SNWgDA1.9zBpMROw512Q/mJnTa74Gq.j7oNmAspAXao9kx1U5NuYMiVaDqGkVq8cfsEHIkvy2g=")
kc.loginResult()

kt2 = LINETCR.LINE() #6
kt2.login(token="EncJRdJYSCGwYFXdGH9a.P4XL0WHwtmxJ1J3gBW6LwG.lFUZRxDUFwiTj4mcQJYvTNB/F/6kd5JBgnOyjwQqHek=")
kt2.loginResult()

ks2 = LINETCR.LINE() #7
ks2.login(token="EnL61IX57znusU6U2Sp8.J+4Xg8PDHUX5MD/u/zYY/a.isj/uHh/84i6twkai4pR3jBRMEh5zyTyDHBB8ZSXKio=")
ks2.loginResult()

ki2 = LINETCR.LINE() #8
ki2.login(token="Eni60WrRoumh6ZwOcwQ4.hyIG0YVMbVXiGhDgDA1Xba.H5rO2u/mlo5R720pZU77zkSSzr1pZG14OoigIODwptU=")
ki2.loginResult()

kk2 = LINETCR.LINE() #9
kk2.login(token="EnmNudrSvHNewaO03u71.ZguoB0RpYTlnvzdSI0AyKq.r5/TLIIMnBBsOqh4d/IJTdchwxYXSePwEnmWSn3JkDM=")
kk2.loginResult()
...
admsa = ["uea937eb29a0304cb01d0f744e7e0be6c"]
...
wait = {
    ...
    "welmsg":"Assalamualaikum selamat datang di grup kami",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#==================================================================
              ...
              if msg.from_ in admin:
                ...
                if msg.from_ in admsa:
                    ...
                    gs = kt2.getGroup(msg.to)
                    gs = ks2.getGroup(msg.to)
                    gs = ki2.getGroup(msg.to)
                    gs = kk2.getGroup(msg.to)
                    targets = []
                    for g in gs.members:
                        if _nametarget == g.displayName:
                            targets.append(g.mid)
...
#========================================
              ...
              if msg.from_ in admin:
                    ...
                    time.sleep(0.0001)
                    ks2.acceptGroupInvitationByTicket(msg.to,Ticket)
                    time.sleep(0.0001)
                    ki2.acceptGroupInvitationByTicket(msg.to,Ticket)
                    time.sleep(0.0001)
                    kk2.acceptGroupInvitationByTicket(msg.to,Ticket)
                    time.sleep(0.0001)
					G = cl.getGroup(msg.to)
					G.preventJoinByTicket = True
					cl.updateGroup(G)
